...
declare-option str gray 'rgb:88846F'
...
set-face global PrimaryCursor "%opt{dark},%opt{green}"
set-face global SecondaryCursor "%opt{dark},%opt{gray}"
set-face global PrimaryCursorEol "%opt{dark},%opt{orange}"
set-face global SecondaryCursorEol "%opt{dark},%opt{white}"
set-face global LineNumbers "%opt{gray},%opt{black}"
set-face global LineNumberCursor "%opt{green},%opt{black}+b"
...
set-face global MatchingChar "%opt{green},%opt{black}+b"
